...
const ManageCars = () => {
    ...
    const {isOwner, axios, currency, setOwnerRefresh } = useAppContext()
                    ...
                    <tr key={index} className='border-t border-borderColor'>
                        <td className='p-3 flex items-center gap-3'>
                            ...
                            <div className='max-md:hidden'>
                                ...
                                <p className='text-xs text-gray-500'>{car.seating_capacity} seater • {car.transmission}</p>
                            </div>
                        </td>
                        ...
                        <td className='flex items-center p-3'>
                            <img onClick={()=> toggleAvailability(car._id)} src={car.isAvailable ? assets.eye_icon : assets.eye_close_icon} alt="" className='cursor-pointer'/>
