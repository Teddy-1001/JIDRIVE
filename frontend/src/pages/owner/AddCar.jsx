...
const AddCar = () => {
    ...
    const { axios, currency, fetchCars, setOwnerRefresh } = useAppContext()
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                try{ fetchCars() }catch(e){}
                if (typeof setOwnerRefresh === 'function') setOwnerRefresh(prev => prev + 1)
            }
            else {
    ...
    return (
        <div className='px-4 py-10 md:px-10 flex-1'>
            <Title title='Add new car' subTitle='Fill in the datails to list a new car for booking, including pricing, availability and car specification' />
            <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div className='flex flex-col w-full'>
                        <label>Brand</label>
                        <input type="text" placeholder='e.g. BMW, Merceded, Audi...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.brand} onChange={e => setCar({ ...car, brand: e.target.value })} />
                    </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                    ...
                    <div className='flex flex-col w-full'>
                        ...
                        <select className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' onChange={e => setCar({ ...car, category: e.target.value })} value={car.category}>
                            ...
                            <option value="SUV">Economy</option>
                            <option value="Van">Premium</option>
                ...
                {/* car transmition, fuel type, seat capacity */}
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                    <div className='flex flex-col w-full'>
                        ...
                        <select className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' onChange={e => setCar({ ...car, transmission: e.target.value })} value={car.transmission}>
                            ...
                            <option option value="Automatic">Automatic</option>
                            <option value="Manual">Manual</option>
                            <option value="H-shifter">H-shifter</option>
                    ...
                    <div className='flex flex-col w-full'>
                        ...
                        <select className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' onChange={e => setCar({ ...car, fuel_type: e.target.value })} value={car.fuel_type}>
                            ...
                            <option option value="Petrol">Petrol</option>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <select className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' onChange={e => setCar({ ...car, location: e.target.value })} value={car.location}>
                        ...
                        <option option value="Nyeri">Nyeri</option>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <textarea rows={6} placeholder='A luxurious SUV with heavy engine' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChange={e => setCar({ ...car, description: e.target.value })}></textarea>
                </div>

                <button disabled={isLoading} className='flex items-center gap-2 px-4 py-2.5 mt-4 bg-primary text-white rounded-md font-medium w-max cursor-pointer'>
