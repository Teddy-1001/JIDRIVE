...
const Footer = () => {
  return (
    <>
            ...
            `}</style>
            <footer className='bg-primary-dull py-12 px-4 sm:px-6 lg:px-8 mt-25'>
                <div className='w-full max-w-7xl mx-auto'>
            
                    <div className="flex flex-wrap justify-between gap-y-12 lg:gap-x-8 pb-6 border-borderColor">
                        ...
                        <div className="w-full md:w-[45%] lg:w-[15%] flex flex-col items-center md:items-start text-center md:text-left">
                            ...
                            <div className="flex flex-col gap-2 mt-6">
                                ...
                                <a href="#" className='text-sm text-white/60 hover:text-white transition-colors'> Gmail</a>
                            </div>
                        </div>
            
                        <div className="w-full text-white/60  md:w-[45%] lg:w-[25%] flex flex-col items-center md:items-start cursor-pointer text-center md:text-left">
                            <h3 className='text-sm text-white font-medium'>Contact</h3>
                            <div className="flex items-center gap-2 max-w-80 w-full overflow-hidden mt-4">
                                <ul className='mt-3 flex flex-col gap-1.5 text-sm'>
                                    <li className='text-sm text-white/60 hover:text-white transition-colors'>1234 Eldoret,Drive</li>
                                    <li className='text-sm text-white/60 hover:text-white transition-colors'>Roadblock, Elizabeth Street</li>
                                    <li className='text-sm text-white/60 hover:text-white transition-colors'>+254 7988898</li>
                                    <li className='text-sm text-white/60 hover:text-white transition-colors'>info@jidrive.com</li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className='text-xs text-white/60'>© {new Date().getFullYear()} Jidrive</p>
