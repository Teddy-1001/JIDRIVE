...
const Testimonial = () => {
    ...
    return (
        <div className='py-28 px-6 md:px-16 lg:px-24 xl:px-44'>
            <Title title='What our customers say' subTitle='Discover why discerning travelers choose stayVenture for their luxury accomodation around the world' />
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 pt-14">
                <div className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5">
                    ...
                    <div className="flex flex-col items-center px-5 py-4 relative">
                        <img className="h-24 w-24 absolute -top-14 rounded-full" src={assets.testimonial_image_1} alt="userImage1" />
                        <div className="pt-8 text-center">
                            <h1 className="text-lg font-medium text-gray-800">Webo Teddy</h1>
                ...
                <div className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5">
                    <div className="flex flex-col items-center px-5 py-4 relative">
                        <img className="h-24 w-24 absolute -top-14 rounded-full" src={assets.testimonial_image_2} alt="userImage2" />
                        <div className="pt-8 text-center">
                ...
                <div className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5">
                    <div className="flex flex-col items-center px-5 py-4 relative">
                        <img className="h-24 w-24 absolute -top-14 rounded-full" src={assets.testimonial_image_2} alt="userImage3" />
                        <div className="pt-8 text-center">
